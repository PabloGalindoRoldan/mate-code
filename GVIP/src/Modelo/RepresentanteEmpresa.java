...
public class RepresentanteEmpresa extends Usuario {
    private String cuit;
    public RepresentanteEmpresa(String nombre, String apellido, String email, String nombreUsuario, String contraseña, String cuit) throws Exception {
        super(nombre, apellido, email, nombreUsuario, contraseña);
        validarCuit(cuit);
        this.cuit = cuit;
    }
    private void validarCuit(String cuit) throws Exception {
