...
public class FakeDaoInmobiliario implements DAOInmobiliario{
    ...
    private void asignarLotes(){
        // 3 lotes vendidos
        listLotes.add(new LoteDTO(1, 100.0, Lote.VENDIDO, LocalDate.of(2023, 1, 1), 100000.0));
        listLotes.add(new LoteDTO(2, 150.0, Lote.VENDIDO, LocalDate.of(2023, 2, 1), 150000.0));
        listLotes.add(new LoteDTO(3, 200.0, Lote.VENDIDO, LocalDate.of(2023, 3, 1), 200000.0));

        // 3 lotes reservados
        listLotes.add(new LoteDTO(4, 120.0, Lote.RESERVADO, null, 0.0));
        listLotes.add(new LoteDTO(5, 180.0, Lote.RESERVADO, null, 0.0));
        listLotes.add(new LoteDTO(6, 220.0, Lote.RESERVADO, null, 0.0));

        // 3 lotes disponibles
        listLotes.add(new LoteDTO(7, 110.0, Lote.DISPONIBLE, null, 0.0));
        listLotes.add(new LoteDTO(8, 160.0, Lote.DISPONIBLE, null, 0.0));
        listLotes.add(new LoteDTO(9, 210.0, Lote.DISPONIBLE, null, 0.0));
    }
    public Lote getLote() {
        return lote;
    }
