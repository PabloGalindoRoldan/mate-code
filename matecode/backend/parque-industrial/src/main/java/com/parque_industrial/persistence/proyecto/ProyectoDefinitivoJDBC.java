...
// public class ProyectoDefinitivoJDBC implements
// ProyectoDAO<ProyectoDefinitivo> {
...
// "(identificacion, actividad_principal, referente, superficie, energia,
// personal, estado, " +
...
// // BUSCAR POR ID
// public ProyectoDefinitivo buscarPorId(String identificacion) throws
// SQLException {
...
// // BUSCAR POR ESTADO
// public List<ProyectoDefinitivo> buscarPorEstado(String estado) throws
// SQLException {
...
// SET actividad_principal = ?, referente = ?, superficie = ?, energia = ?,
// personal = ?, estado = ?,
// fecha_inicio = ?, fecha_fin = ?, viabilidad_financiera = ?, informe_ambiental
// = ?
