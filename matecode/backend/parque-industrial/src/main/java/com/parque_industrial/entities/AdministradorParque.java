...
public class AdministradorParque extends Usuario {
     ...
     //
     // entiendo que el admin es quien decide si el proyecto se aprueba, rechaza o
     // rectifica,
     // si nosotros pusismos q el gestor de proyectos iba a contener todos los
     // proyectos, entonces quien contenga un gestor
